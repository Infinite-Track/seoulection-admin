...
public class SurveyOptionRepositoryImpl implements SurveyOptionRepository {
    ...
    @Override
    public List<SurveyOption> findByQuestionKey(SurveyQuestionKey questionKey) {
    ...
    @Override
    public boolean existsByQuestionKeyAndCode(SurveyQuestionKey questionKey, String code) {
