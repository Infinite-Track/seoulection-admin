...
interface SurveyQuestionJpaRepository extends JpaRepository<SurveyQuestionJpaEntity, SurveyQuestionKey> {

    List<SurveyQuestionJpaEntity> findAllByOrderBySortOrderAsc();
}
